...
\defineAuthor{surname2}{Mirida}
\defineAuthor{firstname2}{Joanna Katherine U.}

\defineAuthor{surname3}{Amado}
\defineAuthor{firstname3}{Dan Paulo E.}

\newcommand{\documentTitle}{ Development of an Automated Plant-watering System Using Soil Moisture Sensors in a Greenhouse Plantation for Palm Plants} % put tilde (~) between words to indicate non-breaking adjacent words
